    ...
    return (
        <section className="py-24 bg-white text-[#1D1D1F] border-t border-dashed border-zinc-200">
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    <span className="inline-block px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-[10px] font-bold uppercase tracking-widest mb-6">
                        Flexibilité Totale
                    </span>
                    <h2 className="text-4xl md:text-5xl font-semibold tracking-tight mb-6">
                        Conçu pour être <span className="text-blue-600">unique.</span>
                    </h2>
                    <p className="text-xl text-zinc-500 max-w-2xl mx-auto font-medium leading-relaxed">
                        Chaque établissement est différent. Notre architecture modulaire permet une personnalisation poussée sans compromettre la stabilité.
                    </p>
                </motion.div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {features.map((feature, i) => (
                        ...
                        >
                            <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-blue-600 mb-6 shadow-sm group-hover:scale-110 transition-transform duration-300">
