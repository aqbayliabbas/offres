    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-4">
            ...
            <motion.div
                ...
                className="relative w-full max-w-2xl max-h-[90vh] bg-white rounded-[24px] sm:rounded-[40px] border border-black/5 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.1)] overflow-hidden flex flex-col"
            >
                {/* Close Button */}
                <button
                    type="button"
                    onClick={() => setIsOpen(false)}
                    className="absolute top-4 right-4 sm:top-6 sm:right-6 p-2 hover:bg-zinc-100 rounded-full transition-colors z-20 bg-white/80 backdrop-blur-sm"
                >
